...
mixin _$ResultState<T> {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(Error<T> value) failed,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(Error<T> value)? failed,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$IdleImpl<T> with DiagnosticableTreeMixin implements Idle<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'ResultState<$T>.initial'));
  }
...
class _$DataImpl<T> with DiagnosticableTreeMixin implements Data<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ResultState<$T>.loaded'))
...
class _$ErrorImpl<T> with DiagnosticableTreeMixin implements Error<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ResultState<$T>.failed'))
