...
class CCDivisionDropDownWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CustomerCreateCubit, CustomerCreateState>(
      builder: (context, state,) {
        return DropdownSearch<DivisionModel>(
                ...
                dropdownBuilder: (context, selectedItems) => state.selectedDivisionModel == null ?  const CommonTextWidget(title: "Select your division",fontWeight: FontWeight.w500,textColor: Colors.grey,) : CommonTextWidget(title: state.selectedDivisionModel!.divisionName.toString()) ,
    ...
    itemAsString: (item) => item.divisionName.toString(),
                ...
                clearButtonProps:  ClearButtonProps(
                  ...
                  onPressed: () {
                    context.read<CustomerCreateCubit>().clearSelectedDivisionModel();
                  }
                ...
                onChanged: (values) {
                 if(values != null) {
                  context.read<CustomerCreateCubit>().setSelectedDivisionModel(divisionModel: values);
