  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CustomerCreateCubit, CustomerCreateState>(
      builder: (context, state) {
        ...
        }, validator: (val) => state.customerCreateAddressField.value.fold((l) => l.maybeMap(orElse: () => null,empty: (value) => "Address  is empty",tooShort: (value) => "Address is too short",), (r) => null), labelText: "Address", hintText: "Enter customer address", autovalidateMode: state.showInputError ? AutovalidateMode.always : AutovalidateMode.onUserInteraction);
      },
    );
  }
}
