  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              onPressed: () {
                ...
                if (context.mounted) {
                  Navigator.push(
                      context,
                      ScaleRoute(
                          screen: CustomerUpdateForm(
                              farmid: widget.customermodel?.farm?.farmId
                                  .toString())));
                }
              },
      ...
      body:  widget.customermodel == null
              ? const Center(
                  child: Text(
                      'Something went wrong , please select another customer'),
                )
              : SafeArea(
                  child: Padding(
                      ...
                      children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget.customermodel?.farm!.customerId
                                      .toString(),
                                ),
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget.customermodel?.farm!.farmId
                                      .toString(),
                                ),
                                const CustomerDetailsDividerWidget(),
                                10.verticalSpace,
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget.customermodel?.farm!.farmName ??
                                      "N/A",
                                ),
                                const CustomerDetailsDividerWidget(),
                                10.verticalSpace,
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget
                                          .customermodel?.farm!.custLocation ??
                                      'N/A',
                                ),
                                const CustomerDetailsDividerWidget(),
                                10.verticalSpace,
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget.customermodel?.farm?.custZone ??
                                      'N/A',
                                ),
                                const CustomerDetailsDividerWidget(),
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget
                                      .customermodel?.farm?.contactPerson
                                      .toString(),
                                ),
                                const CustomerDetailsDividerWidget(),
                                10.verticalSpace,
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget
                                      .customermodel?.farm!.contPersContactNo
                                      .toString(),
                                ),
                                const CustomerDetailsDividerWidget(),
                                10.verticalSpace,
                                ...
                                CustomerDetailsTextWidget(
                                  data: widget.customermodel?.farm!
                                          .contPersAltContNo ??
                                      "N/A",
                                ),
                                const CustomerDetailsDividerWidget(),
                                ...
                                CustomerDetailsTextWidget(
                                  data:
                                      widget.customermodel!.farm!.custStateCode,
                                ),
                                ...
                                CustomerDetailsTextWidget(
                                  maxline: 10,
                                  data: widget
                                      .customermodel!.farm!.custCreditLimit,
                                ),
                                ...
                                CustomerDetailsTextWidget(
                                  data:
                                      widget.customermodel!.farm!.customerCode,
                                ),
                                ...
                                CustomerDetailsTextWidget(
                                  data:
                                      widget.customermodel!.farm!.locationCode,
                                ),
                        ...
                        BlocBuilder<CheckinCubit, CheckinState>(
                          builder: (context, state) {
                            ...
                            if (state.lastCheckinOutResponseModel != null &&
                                state.lastCheckinOutResponseModel!.status ==
                                    true) {
                              return CommonButton(
                                callback: () async {
                                  if (context.mounted) {
                        ...
                        // BlocBuilder<CheckinCubit, CheckinState>(
                        //   builder: (context, state) {
                        //     return state.lastCheckinOutResponseModel != null &&
                        //             state.lastCheckinOutResponseModel!.status == true
                        //         ? CommonButton(
                        //             callback: () async {
                        //               if (context.mounted) {
                        //                 Navigator.pushReplacement(
