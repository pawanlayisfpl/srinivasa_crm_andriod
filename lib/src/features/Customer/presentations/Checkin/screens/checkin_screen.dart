          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(
                    widget.customermodel.farm!.isIndividual == true
                        ? widget.customermodel.farm!.farmName.toString()
                        : widget.customermodel.customerName ?? 'N/A',
                    maxLines: 1),
              ),
              const Divider(),
              10.verticalSpace,
              ...
              context.watch<CheckinCubit>().state.isLoading
                  ...
                  : CommonButton(
                      callback: () async {
                        ...
                        String? lastCheckinTimeString = locator
                            .get<KeyValueStorage>()
                            .sharedPreferences
                            .getString(KeyValueStrings.checkinTime);
                        debugPrint(lastCheckinTimeString ??
                            'No last check in time found');
                        ...
                        CheckinPostModel checkInPostModel = CheckinPostModel(
                          ...
                          customerid: int.tryParse(
                                  widget.customermodel.farm!.customerId!) ??
                              0,
                        ...
                        if (context.mounted) {
                          await context.read<CheckinCubit>().checkInLogic(
                              context: context,
                              checkInPostModel: checkInPostModel,
