...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i47.MarkAttendanceRepo>(() => _i48.MarkAttendanceRepoImpl(
        markAttendanceRemoteDataSource:
            gh<_i42.MarkAttendanceRemoteDataSource>()));
    gh.factory<_i49.EmployeRepo>(() =>
        _i50.EmployeRepoImpl(employeDataSource: gh<_i38.EmployeDataSource>()));
    gh.factory<_i51.PunchInUseCase>(() =>
        _i51.PunchInUseCase(markAttendanceRepo: gh<_i47.MarkAttendanceRepo>()));
    gh.factory<_i52.PunchOutUsecase>(() => _i52.PunchOutUsecase(
        markAttendanceRepo: gh<_i47.MarkAttendanceRepo>()));
    gh.factory<_i53.LastPunchInOutUseCase>(() => _i53.LastPunchInOutUseCase(
        markAttendanceRepo: gh<_i47.MarkAttendanceRepo>()));
    gh.factory<_i54.CheckinCubit>(() => _i54.CheckinCubit(
          customerRepo: gh<_i32.CustomerRepo>(),
          employeRepo: gh<_i49.EmployeRepo>(),
    ...
    gh.factory<_i56.CreateMonthlyPlanCubit>(() => _i56.CreateMonthlyPlanCubit(
          monthlyPlanRepo: gh<_i43.MonthlyPlanRepo>(),
          employeRepo: gh<_i49.EmployeRepo>(),
        ));
    gh.factory<_i57.MarkAttendanceCubit>(() => _i57.MarkAttendanceCubit(
          gh<_i58.PunchInUseCase>(),
          gh<_i58.PunchOutUsecase>(),
          gh<_i58.LastPunchInOutUseCase>(),
        ));
    return this;
  }
}

class _$ThirdPartyDependencies extends _i59.ThirdPartyDependencies {}
