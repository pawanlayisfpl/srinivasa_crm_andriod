...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i44.CustomerRepo>(() => _i45.CustomerRepoImpl(
        customerRemoteDataSource: gh<_i31.CustomerRemoteDataSource>()));
    gh.factory<_i46.SearchCustomerCubit>(
    ...
    gh.factory<_i54.SalesOrderCreateCubit>(() => _i54.SalesOrderCreateCubit(
          salesRepo: gh<_i23.SalesRepo>(),
          keyValueStorage: gh<_i22.KeyValueStorage>(),
          customerRepo: gh<_i44.CustomerRepo>(),
        ));
    gh.factory<_i55.AllCustomerCubit>(
        () => _i55.AllCustomerCubit(customerRepo: gh<_i44.CustomerRepo>()));
    gh.factory<_i56.CustomerFullDetailsCubit>(() =>
        _i56.CustomerFullDetailsCubit(customerRepo: gh<_i44.CustomerRepo>()));
    gh.factory<_i57.LoginUseCase>(
        () => _i57.LoginUseCase(loginRepository: gh<_i24.LoginRepository>()));
    gh.factory<_i58.MarkAttendanceRemoteDataSource>(
        () => _i58.MarkAttendanceRemoteDatasourceImpl(
              dioClient: gh<_i22.DioClient>(),
              logger: gh<_i5.Logger>(),
              keyValueStorage: gh<_i22.KeyValueStorage>(),
            ));
    gh.factory<_i59.AddressRepo>(() => _i60.AddressRepoImpl(
        addressRemoteDataSource: gh<_i33.AddressRemoteDataSource>()));
    gh.factory<_i61.ZoneRepo>(() => _i62.ZoneRepoImpl(
        zoneRemoteDataSource: gh<_i42.ZoneRemoteDataSource>()));
    gh.factory<_i63.MonthlyPlanRepo>(() => _i64.MonthlyPlanRepoImpl(
        remoteDataSource: gh<_i41.MonthlyPlanRemoteDataSource>()));
    gh.factory<_i65.AlertCubit>(() => _i65.AlertCubit(gh<_i35.AlertRepo>()));
    gh.factory<_i66.ViewMonthlyPlanCubit>(
        () => _i66.ViewMonthlyPlanCubit(gh<_i63.MonthlyPlanRepo>()));
    gh.factory<_i67.MonthlyPlanPendingCubit>(
        () => _i67.MonthlyPlanPendingCubit(gh<_i63.MonthlyPlanRepo>()));
    gh.factory<_i68.MonthlyPlanSearchCubit>(
        () => _i68.MonthlyPlanSearchCubit(gh<_i63.MonthlyPlanRepo>()));
    gh.factory<_i69.MarkAttendanceRepo>(() => _i70.MarkAttendanceRepoImpl(
        markAttendanceRemoteDataSource:
            gh<_i58.MarkAttendanceRemoteDataSource>()));
    gh.factory<_i71.PrimarySourceRepo>(() => _i72.PrimarySourceRepoImpl(
        primarySourceRemoteDataSource:
            gh<_i43.PrimarySourceRemoteDataSource>()));
    gh.factory<_i73.EmployeRepo>(() =>
        _i74.EmployeRepoImpl(employeDataSource: gh<_i53.EmployeDataSource>()));
    gh.factory<_i75.PunchInUseCase>(() =>
        _i75.PunchInUseCase(markAttendanceRepo: gh<_i69.MarkAttendanceRepo>()));
    gh.factory<_i76.PunchOutUsecase>(() => _i76.PunchOutUsecase(
        markAttendanceRepo: gh<_i69.MarkAttendanceRepo>()));
    gh.factory<_i77.LastPunchInOutUseCase>(() => _i77.LastPunchInOutUseCase(
        markAttendanceRepo: gh<_i69.MarkAttendanceRepo>()));
    gh.factory<_i78.CheckinCubit>(() => _i78.CheckinCubit(
          customerRepo: gh<_i44.CustomerRepo>(),
          employeRepo: gh<_i73.EmployeRepo>(),
          purposeRepo: gh<_i47.PurposeRepo>(),
          commonImageServices: gh<_i17.CommonImageServices>(),
        ));
    gh.factory<_i79.CustomerCreateCubit>(() => _i79.CustomerCreateCubit(
          primarySourceRepo: gh<_i71.PrimarySourceRepo>(),
          addressRepo: gh<_i59.AddressRepo>(),
          zoneRepo: gh<_i61.ZoneRepo>(),
          customerRepo: gh<_i44.CustomerRepo>(),
          divisionRepo: gh<_i50.DivisionRepo>(),
        ));
    gh.factory<_i80.LoginCubit>(() => _i80.LoginCubit(
          gh<_i57.LoginUseCase>(),
          gh<_i22.KeyValueStorage>(),
        ));
    gh.factory<_i81.UpdateMonthlyPlanCubit>(() => _i81.UpdateMonthlyPlanCubit(
        monthlyPlanRepo: gh<_i63.MonthlyPlanRepo>()));
    gh.factory<_i82.CreateMonthlyPlanCubit>(() => _i82.CreateMonthlyPlanCubit(
          monthlyPlanRepo: gh<_i63.MonthlyPlanRepo>(),
          employeRepo: gh<_i73.EmployeRepo>(),
        ));
    gh.factory<_i83.MarkAttendanceCubit>(() => _i83.MarkAttendanceCubit(
          gh<_i84.PunchInUseCase>(),
          gh<_i84.PunchOutUsecase>(),
          gh<_i84.LastPunchInOutUseCase>(),
        ));
    return this;
  }
}

class _$ThirdPartyDependencies extends _i85.ThirdPartyDependencies {}
